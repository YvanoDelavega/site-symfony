...
class RegistrationType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('picture', UrlType::class, $this->getConfig("Photo de profil", "URL de votre photo"))
            ...
            ->add('description', TextareaType::class, $this->getConfig("Description détaillée", "C'est le moment de vous présenter en détail"))
        ;
    }
